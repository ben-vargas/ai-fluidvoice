...
| Grok Speech (xAI) | Opt-in cloud dictation (credentials configurable; Activate arrives with the socket) | 25 languages (select or Auto) | Cloud — no download | Apple Silicon + Intel |
